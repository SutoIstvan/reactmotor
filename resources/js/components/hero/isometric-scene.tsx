...
function IsometricBuilding({
    ...
    const colorSets = {
        ...
        teal: {
            ...
            left: 'hsl(0 72% 46%)',
            right: 'hsl(0 72% 36%)',
            glow: 'hsl(0 72% 56% / 0.4)',
            border: 'hsl(0 72% 76% / 0.6)',
        },
        gold: {
            top: 'hsl(48 93% 66%)',
            left: 'hsl(48 93% 56%)',
    ...
    const colors =
        colorSets[color as keyof typeof colorSets] || colorSets.slate;
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <path
                            d="M280 140 L360 100 L440 140 L360 180 Z"
                            fill="hsl(220 26% 20%)"
                            stroke="hsl(220 26% 30% / 0.4)"
                            strokeWidth="0.5"
                        />
                        <path
                            d="M280 140 L280 155 L360 195 L360 180 Z"
                            fill="hsl(220 26% 26%)"
                            stroke="hsl(220 26% 36% / 0.3)"
                            strokeWidth="0.5"
                        />
                        <path
                            d="M360 180 L360 195 L440 155 L440 140 Z"
                            fill="hsl(220 26% 30%)"
                            stroke="hsl(220 26% 40% / 0.3)"
                            strokeWidth="0.5"
                        />
                    </motion.g>
