  ...
  return (
    <g>
      ...
      <motion.circle
        ...
        style={{ filter: "blur(4px)", offsetPath: `path("${path}")` } as React.CSSProperties}
        ...
        >
          <defs>
            ...
            <radialGradient id="glowGradient" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="hsl(0 72% 56%)" stopOpacity="0.12" />
              <stop offset="50%" stopColor="hsl(0 72% 56%)" stopOpacity="0.05" />
