        ...
        >
            <div className="relative z-10 container mx-auto px-6 lg:px-12">
                <motion.div
                    ...
                    className="bg-foreground relative overflow-hidden rounded-3xl p-12 lg:p-20"
                >
                    {/* Background decoration */}
                    <div className="bg-teal/20 absolute top-0 right-0 h-96 w-96 translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl" />
                    <div className="bg-coral/20 absolute bottom-0 left-0 h-96 w-96 -translate-x-1/2 translate-y-1/2 rounded-full blur-3xl" />
                    ...
                    <div className="relative z-10 mx-auto max-w-3xl text-center">
                        ...
                        <motion.div
                            ...
                            className="text-background/50 mt-12 flex flex-wrap items-center justify-center gap-6 text-sm"
                        >
